...
void putc(uint8_t c);
void backspace(void);               // backspace funtion 
void scrolling(uint8_t c);          // scrolling function
void leftCursor(void);              // top left cursor update function
void updateCursor(void);            // updates cursor positon on screen
